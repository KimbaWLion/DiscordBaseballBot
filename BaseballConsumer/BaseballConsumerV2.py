...
class BaseballUpdaterBotV2:
            ...
            for game in sched:
                ...
                if gameStatus == 'Scheduled':
                    ...
                    if gameStatusId not in idsOfPrevEvents:
                        self.postGameStatusOnDiscord(channel, game)
    ...
    async def postGameStatusOnDiscord(self, channel, game):
        ...
        if game['status'] == 'Delayed: Rain':
            gameStatusEmbed = discord.Embed(title="RAIN_DELAY_STATUS_PLACEHOLDER_TITLE",
                                            description="RAIN_DELAY_STATUS_PLACEHOLDER_DESCRIPTION")
